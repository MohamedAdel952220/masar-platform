 ...
 *
 * `identity.guardian_profiles.id` is the auth user id (Epic 1 keys the identity
 ...
 *
 * The profile is read-only: a guardian's own name, phone and national ID are
 * maintained by the nursery, and no guardian-facing update RPC exists.
 */
...
export function SettingsRoute() {
  ...
  const profile = useIdentityList(tenantId, 'guardian_profiles', { orderBy: 'created_at', limit: 5 });
