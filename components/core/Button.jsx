  ...
  return (
    <button
      ...
      style={{
        ...
        fontFamily: 'var(--font-sans)', fontSize: s.fontSize, fontWeight: 'var(--weight-bold)',
        letterSpacing: 'var(--tracking-snug)', borderRadius: s.radius, cursor: disabled ? 'not-allowed' : 'pointer',
        opacity: disabled ? 0.5 : 1, whiteSpace: 'nowrap', boxShadow: variant === 'primary' ? 'var(--shadow-sm)' : 'none',
